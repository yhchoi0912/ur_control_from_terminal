...
bool move_relative_ur__msg__error_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_relative_ur.msg._error_msg.ErrorMsg", full_classname_dest, 40) == 0);
  }
  move_relative_ur__msg__ErrorMsg * ros_message = _ros_message;
  {  // message
...
PyObject * move_relative_ur__msg__error_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("move_relative_ur.msg._error_msg");
